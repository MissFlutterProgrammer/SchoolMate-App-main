// ignore_for_file: avoid_print, invalid_use_of_protected_member, prefer_typing_uninitialized_variables
...
class ShimmerPdfLoading extends StatelessWidget {
  const ShimmerPdfLoading({super.key});
