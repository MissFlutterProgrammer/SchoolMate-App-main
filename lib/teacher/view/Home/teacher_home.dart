// ignore_for_file: avoid_print, invalid_use_of_protected_member, prefer_typing_uninitialized_variables, camel_case_types, must_be_immutable, unused_local_variable
...
class programCard extends StatefulWidget {
  programCard({super.key, required this.gProgram});
                ...
                children: [
                  InkWell(
                    onTap: () async {
                      ...
                      final Uri url = Uri.parse(widget.gProgram.url!);
